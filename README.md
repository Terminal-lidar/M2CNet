...
datasets SemanticKITTI and nuScenes (achieving mIoU scores of 65.7% and 78.9% respectively), the off-road dataset RELLIS-
3D (44.6%), and a real-world test set. Experimental results demonstrate that our method surpasses representative methods
in both effectiveness and scene adaptability.
